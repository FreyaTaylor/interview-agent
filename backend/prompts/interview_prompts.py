...
4. 对 knowledge 类：
   ...
   - original_dialogue: 从原文中提取该知识点相关的**原始对话片段**（面试官问+候选人答的原文，保留原始措辞）
5. 对 algorithm 类，尝试匹配 LeetCode 题号，同样提取 original_dialogue
6. 对 hr 类，同样提取 original_dialogue
7. 用户输入可能含错别字（语音转写），按语义理解
8. 如果文本中没有明确的回答内容，user_answer 设为空字符串
